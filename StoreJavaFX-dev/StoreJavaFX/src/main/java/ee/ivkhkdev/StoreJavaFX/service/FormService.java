...
public class FormService {
    ...
    public void loadNewProductForm() {
        ...
        Scene scene = new Scene(root);
        getPrimaryStage().setScene(scene);
        getPrimaryStage().setTitle("PetStore - Создание нового оборудования");
    }
    ...
    public void loadEditProductForm(Product selectedProduct) {
        ...
        try {
            ...
            getPrimaryStage().setTitle("PetStore - Редактирование оборудования");
            getPrimaryStage().setScene(scene);
    ...
    public void loadSelectedProductForm(Product selectedProduct) {
        ...
        try {
            ...
            stage.setTitle("PetStore - Информация об оборудовании");
